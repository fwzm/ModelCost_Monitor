...
class L10nLocalizations {
  ...
  String get helpOverviewTitle => L10n.of('help_overview_title');
  String get helpOverviewDesc => L10n.of('help_overview_desc');
  String get helpOverviewFeature1 => L10n.of('help_overview_feature1');
  String get helpOverviewFeature2 => L10n.of('help_overview_feature2');
  String get helpOverviewFeature3 => L10n.of('help_overview_feature3');
  String get helpOverviewFeature4 => L10n.of('help_overview_feature4');
  String get helpOverviewFeature5 => L10n.of('help_overview_feature5');
  String get helpOverviewFeature6 => L10n.of('help_overview_feature6');
  String get helpDashboardTitle => L10n.of('help_dashboard_title');
  String get helpDashboardDesc => L10n.of('help_dashboard_desc');
  String get helpDashboardProxyCard => L10n.of('help_dashboard_proxy_card');
  String get helpDashboardStats => L10n.of('help_dashboard_stats');
  String get helpDashboardActivity => L10n.of('help_dashboard_activity');
  String get helpAccountsTitle => L10n.of('help_accounts_title');
  String get helpAccountsDesc => L10n.of('help_accounts_desc');
  String get helpAccountsAdd => L10n.of('help_accounts_add');
  String get helpAccountsManage => L10n.of('help_accounts_manage');
  String get helpPricingTitle => L10n.of('help_pricing_title');
  String get helpPricingDesc => L10n.of('help_pricing_desc');
  String get helpPricingWhy => L10n.of('help_pricing_why');
  String get helpPricingAdd => L10n.of('help_pricing_add');
  String get helpPricingView => L10n.of('help_pricing_view');
  String get helpLogsTitle => L10n.of('help_logs_title');
  String get helpLogsDesc => L10n.of('help_logs_desc');
  String get helpLogsFilter => L10n.of('help_logs_filter');
  String get helpLogsRecord => L10n.of('help_logs_record');
  String get helpLogsExport => L10n.of('help_logs_export');
  String get helpChartsTitle => L10n.of('help_charts_title');
  String get helpChartsDesc => L10n.of('help_charts_desc');
  String get helpChartsTypes => L10n.of('help_charts_types');
  String get helpProxyTitle => L10n.of('help_proxy_title');
  String get helpProxyDesc => L10n.of('help_proxy_desc');
  String get helpProxyHow => L10n.of('help_proxy_how');
  String get helpProxySetup => L10n.of('help_proxy_setup');
  String get helpProxyHttps => L10n.of('help_proxy_https');
  String get helpProxyLan => L10n.of('help_proxy_lan');
  String get helpProxyCors => L10n.of('help_proxy_cors');
  String get helpSettingsTitle => L10n.of('help_settings_title');
  String get helpSettingsDesc => L10n.of('help_settings_desc');
  String get helpSettingsProxy => L10n.of('help_settings_proxy');
  String get helpSettingsBudget => L10n.of('help_settings_budget');
  String get helpSettingsSystem => L10n.of('help_settings_system');
  String get helpSettingsLang => L10n.of('help_settings_lang');
  String get helpSettingsSecurity => L10n.of('help_settings_security');
  ...
  String get helpFaq5Q => L10n.of('help_faq5_q');
  String get helpFaq5A => L10n.of('help_faq5_a');
  String get helpFaq6Q => L10n.of('help_faq6_q');
  String get helpFaq6A => L10n.of('help_faq6_a');
  String get helpFaq7Q => L10n.of('help_faq7_q');
  String get helpFaq7A => L10n.of('help_faq7_a');
  ...
  String get helpTip5 => L10n.of('help_tip5');
  String get helpTip6 => L10n.of('help_tip6');
