...
class Accounts extends Table {
  ...
  TextColumn get providerType => text().withLength(max: 30)();
...
class UsageLogs extends Table {
  ...
  TextColumn get requestStatus => text().withLength(max: 30)();
  TextColumn get errorMessage => text().nullable()();
  TextColumn get source => text().withLength(max: 30)();
  DateTimeColumn get createdAt => dateTime().withDefault(currentDateAndTime)();
}
...
class AlertRules extends Table {
  ...
  TextColumn get providerType => text().withLength(max: 30).nullable()();
...
class ProviderCapabilities extends Table {
  IntColumn get id => integer().autoIncrement()();
  TextColumn get providerType => text().withLength(max: 30).unique()();
  BoolColumn get supportsBalanceQuery => boolean().withDefault(const Constant(false))();
  BoolColumn get supportsModelList => boolean().withDefault(const Constant(false))();
  BoolColumn get supportsUsageParsing => boolean().withDefault(const Constant(false))();
  BoolColumn get supportsStreaming => boolean().withDefault(const Constant(true))();
  BoolColumn get requiresManualQuota => boolean().withDefault(const Constant(false))();
...
class ProxyRuntimeLogs extends Table {
  IntColumn get id => integer().autoIncrement()();
  TextColumn get eventType => text().withLength(max: 30)();
  TextColumn get previousState => text().withLength(max: 30).nullable()();
  TextColumn get nextState => text().withLength(max: 30).nullable()();
